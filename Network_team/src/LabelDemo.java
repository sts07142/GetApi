...
public class LabelDemo extends JFrame{
   ...
   public LabelDemo (Operator _o) {
      ...
      loginIdText = new JTextField() {
    	  @Override
          public void setBorder(Border border) { //textfeild 테두리 없애기
      ...
      loginBtn.setBorderPainted(false); //버튼 테두리 없애기
      loginBtn.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
      JLabel l1 = new JLabel("---------또는---------");
      l1.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
      ...
      findIdBtn.setBorderPainted(false); //버튼 테두리 없애기
      findIdBtn.setContentAreaFilled(false);
      findIdBtn.setFont(new Font("맑은 고딕", Font.PLAIN, 11));
